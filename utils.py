...
def valida_cpf(cpf_input):
    ...
    while True:
        ...
        if resultado:
            ...
            cpf_input = input("CPF invalido. Digite novamente: ")
...
def valida_data_nascimento(data_nascimento_input):
    ...
    while True:
        ...
        data_nascimento_input = input("Digite a data de Nascimento [formato: dd/mm/yyy]: ")        
        try:
...
def buscar_cep(cep_input):
        ...
        if response.status_code == 200:
            ...
            cep_input = input("CEP invalido. Digite novamente: ")
